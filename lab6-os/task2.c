...
// process 0 calling critical section
// -- count decriments
...
// process 1 calling critical section
// -- count incriments
...
int main() {
    ...
    // Create threads
    pthread_create(&thread0, NULL, process0, NULL);// race conditon using decriment and incriement
