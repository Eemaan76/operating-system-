...
void *process0(void *arg) {
        ...
        flag[0] = 1; // true its flag proccesss 0
        turn = 1;
        while (flag[1]==1 && turn == 1) {  // jis ki while chly gi tu wo wait ma phas jay ga or  dosra critical ma chla jay ga 
            //entry points
            // Busy wait
        }
        // Critical section
        critical_section(0);
        // Exit section
        flag[0] = 0; // fasle its flag process 0
        //sleep(1);
